function [copt,sopt,sdopt,r2opt,itopt,solution]=als_closure2(d,x0,nexp,puntosMatrices,numexp,ExperimentRanges, nit,tolsigma,gr,isp,csel,ssel,vclos1,vclos2,test);
...
[conc2]=closure_multi_lessthan(conc2,iclos(i),sclos1(i,:),iclos1(i),tclos1(i),tclos2(i),sclos2(i,:),iclos2(i),vclos1n,vclos2n);
end
conc(kinic:kfin,:)=conc2;
end
end
